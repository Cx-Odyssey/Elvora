...
function placeOrder(){
  ...
  var order={id:oid,name:name,phone:phone,addr:addr,dist:dist,items:JSON.parse(JSON.stringify(items)),total:total,fee:deliveryFee,promo:appliedPromo?appliedPromo.code:null,date:new Date().toLocaleDateString('en-GB',{day:'numeric',month:'short',year:'numeric'}),status:'Confirmed'};
