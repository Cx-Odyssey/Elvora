...
function navCheckout(){buyNowItem=null;sessionStorage.removeItem('el_buynow');nav('checkout');renderCheckout();}
...
function navFAQ(){nav('faq');}
function navContact(){nav('contact');}
